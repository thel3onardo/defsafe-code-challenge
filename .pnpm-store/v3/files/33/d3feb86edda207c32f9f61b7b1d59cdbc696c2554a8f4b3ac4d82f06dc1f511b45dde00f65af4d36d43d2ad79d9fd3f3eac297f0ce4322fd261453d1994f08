...
var _CustomElementRegistry_instances, _CustomElementRegistry_isValidCustomElementName, _a, _b, _c;
...
_CustomElementRegistry_instances = new WeakSet(), _a = PropertySymbol.registry, _b = PropertySymbol.registedClass, _c = PropertySymbol.callbacks, _CustomElementRegistry_isValidCustomElementName = function _CustomElementRegistry_isValidCustomElementName(name) {
